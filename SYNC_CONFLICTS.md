...
- `11b2f085c` feat: preserve wire session ids across resumed forks
- `244e91e2c` feat: allow model max output token overrides
- `33123ac4f` chore: maintain fork sync and internal release automation
